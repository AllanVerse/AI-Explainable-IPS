...
sniff(prn=packet_callback, filter="ip", store=0, iface="<BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc mq state UP group default qlen 1000
    link/ether 00:15:5d:05:39:0a brd ff:ff:ff:ff:ff:ff
    inet 172.31.26.64/20 brd 172.31.31.255 scope global eth0
       valid_lft forever preferred_lft forever
    inet6 fe80::215:5dff:fe05:390a/64 scope link 
       valid_lft forever preferred_lft forever")